...
class IbPositionSizing():
    def __init__(self, order_dict):
        ...
        # TODO: Make "AvailableFunds" as a parameter
        self.order_dict["available_capital"] = float(self.order_dict["broker"].acc_dict["AvailableFunds"])
    ...
    def get_options_quantity(self):
        self.order_dict["risk_unit"] = abs((self.order_dict["entry"] - self.order_dict["sl"]) * self.order_dict["delta"])*self.order_dict["multiplier"]
        position = PositionSizing(self.order_dict)
